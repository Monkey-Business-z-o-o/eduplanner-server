 ...
 */
@Generated
public class SpringDocConfiguration__TestContext003_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<RequestBodyService> getRequestBodyBuilderInstanceSupplier() {
    return BeanInstanceSupplier.<RequestBodyService>forFactoryMethod(SpringDocConfiguration.class, "requestBodyBuilder", GenericParameterService.class, PropertyResolverUtils.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(SpringDocConfiguration.class).requestBodyBuilder(args.get(0), args.get(1)));
  }
  ...
  /**
   * Bean definitions for {@link SpringDocConfiguration.SpringDocRepositoryRestConfiguration}.
   */
  @Generated
  public static class SpringDocRepositoryRestConfiguration {
    /**
     * Get the bean definition for 'springDocRepositoryRestConfiguration'.
     */
    public static BeanDefinition getSpringDocRepositoryRestConfigurationBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(SpringDocConfiguration.SpringDocRepositoryRestConfiguration.class);
      beanDefinition.setInstanceSupplier(SpringDocConfiguration.SpringDocRepositoryRestConfiguration::new);
      return beanDefinition;
    }

    /**
     * Get the bean instance supplier for 'repositoryRestConfigurationProvider'.
     */
    private static BeanInstanceSupplier<RepositoryRestConfigurationProvider> getRepositoryRestConfigurationProviderInstanceSupplier(
        ) {
      return BeanInstanceSupplier.<RepositoryRestConfigurationProvider>forFactoryMethod(SpringDocConfiguration.SpringDocRepositoryRestConfiguration.class, "repositoryRestConfigurationProvider", Optional.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(SpringDocConfiguration.SpringDocRepositoryRestConfiguration.class).repositoryRestConfigurationProvider(args.get(0)));
    }

    /**
     * Get the bean definition for 'repositoryRestConfigurationProvider'.
     */
    public static BeanDefinition getRepositoryRestConfigurationProviderBeanDefinition() {
      RootBeanDefinition beanDefinition = new RootBeanDefinition(RepositoryRestConfigurationProvider.class);
      beanDefinition.setLazyInit(false);
      beanDefinition.setInstanceSupplier(getRepositoryRestConfigurationProviderInstanceSupplier());
      return beanDefinition;
    }
  }
  ...
  public static class QuerydslProvider {
    ...
    private static BeanInstanceSupplier<QuerydslPredicateOperationCustomizer> getQueryDslQuerydslPredicateOperationCustomizerInstanceSupplier(
      ...
      return BeanInstanceSupplier.<QuerydslPredicateOperationCustomizer>forFactoryMethod(SpringDocConfiguration.QuerydslProvider.class, "queryDslQuerydslPredicateOperationCustomizer", Optional.class, SpringDocConfigProperties.class)
              .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(SpringDocConfiguration.QuerydslProvider.class).queryDslQuerydslPredicateOperationCustomizer(args.get(0), args.get(1)));
    }
