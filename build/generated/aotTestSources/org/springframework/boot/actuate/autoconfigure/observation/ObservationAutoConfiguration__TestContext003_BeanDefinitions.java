 ...
 */
@Generated
public class ObservationAutoConfiguration__TestContext003_BeanDefinitions {
  /**
  ...
  public static class MeterObservationHandlerConfiguration {
    ...
    public static class OnlyMetricsMeterObservationHandlerConfiguration {
      ...
      private static BeanInstanceSupplier<DefaultMeterObservationHandler> getDefaultMeterObservationHandlerInstanceSupplier(
        ...
        return BeanInstanceSupplier.<DefaultMeterObservationHandler>forFactoryMethod(ObservationAutoConfiguration.MeterObservationHandlerConfiguration.OnlyMetricsMeterObservationHandlerConfiguration.class, "defaultMeterObservationHandler", MeterRegistry.class, ObservationProperties.class)
                .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(ObservationAutoConfiguration.MeterObservationHandlerConfiguration.OnlyMetricsMeterObservationHandlerConfiguration.class).defaultMeterObservationHandler(args.get(0), args.get(1)));
      }
