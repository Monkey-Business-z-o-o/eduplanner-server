 ...
 */
@Generated
public class WebMvcEntityLinksConfiguration__TestContext001_BeanDefinitions {
  /**
  ...
  private static BeanInstanceSupplier<OrderAwarePluginRegistry> getEntityLinksPluginRegistryInstanceSupplier(
    ...
    return BeanInstanceSupplier.<OrderAwarePluginRegistry>forFactoryMethod(WebMvcEntityLinksConfiguration.class, "entityLinksPluginRegistry", ApplicationContext.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(WebMvcEntityLinksConfiguration.class).entityLinksPluginRegistry(args.get(0)));
  }
  ...
  private static BeanInstanceSupplier<DelegatingEntityLinks> getDelegatingEntityLinksInstanceSupplier(
    ...
    return BeanInstanceSupplier.<DelegatingEntityLinks>forFactoryMethod(WebMvcEntityLinksConfiguration.class, "delegatingEntityLinks", PluginRegistry.class)
            .withGenerator((registeredBean, args) -> registeredBean.getBeanFactory().getBean(WebMvcEntityLinksConfiguration.class).delegatingEntityLinks(args.get(0)));
  }
